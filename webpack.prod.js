//Este es el archivo de configuración del webpack para producción
...
//Con esto importo el plugin de minify 
...
module.exports = {
    ...
    output:{
        //con lo de content hash se genera un identificador único
        filename: 'main.[contenthash].js',
        //Con esto limpio la carpeta dist
        clean: true
    },
    module:{
        rules: [
            //Esta es la regla para Babel, que traduce de JavaScript moderno a compatible
            {
                test: /\.m?js$/,
